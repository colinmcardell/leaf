//
//  LFMasterSliderViewController.m
//
...
@interface LFMasterSliderViewController ()

@end

@implementation LFMasterSliderViewController

+ (LFMasterSliderViewController *)masterSliderViewController
{
    return [[self alloc] initWithViewModel:[LFMasterSliderPackViewModel viewModel]];
}

- (instancetype)initWithViewModel:(LFMasterSliderPackViewModel *)viewModel
{
...
- (void)viewDidLoad
{
    ...
    LFMasterSliderPackViewModel *viewModel = (LFMasterSliderPackViewModel *)[self viewModel];
