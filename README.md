...
leaf is a dual oscillator synthesizer for iPad with a simple filter,
arpeggiator, and delay (w/LPF). Implemented with Pure Data and libPd, leaf has
grown from experimentation with the intention of learning some Pure Data as well
...
leaf is released under the GPLv3 license. See
[LICENSE](https://github.com/colinmcardell/leaf/blob/master/LICENSE).

## More Info

Have a question? Please
[open an issue](https://github.com/colinmcardell/leaf/issues/new)!
